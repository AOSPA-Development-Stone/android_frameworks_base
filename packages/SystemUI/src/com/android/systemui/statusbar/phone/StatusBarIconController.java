...
public interface StatusBarIconController {
    ...
    class IconManager implements DemoModeCommandReceiver {
        ...
        private StatusBarBluetoothView onCreateStatusBarBluetoothView(String slot, boolean blocked) {
            StatusBarBluetoothView view = StatusBarBluetoothView.fromContext(mContext, slot, blocked);
            return view;
        }
